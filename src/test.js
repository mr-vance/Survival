...
class Level1 {
  ...
  Initialize() {
    ...
    this.enemy = new BasicCharacterController(params);
    console.log("the state is ",this.enemy.state)
  ...
  addGround() {
    ...
    var mesh = new THREE.Mesh(
      new THREE.PlaneBufferGeometry(500, 600),
      groundMaterial
    );
    mesh.position.y = -40;
  ...
  addCheckpointLine() {
    const mirrorBack1 = new Reflector(new THREE.PlaneBufferGeometry(500, 4), {
  ...
  buildStreetLightBulb() {
    ...
    pointLight.add(
      new THREE.Mesh(
        new THREE.SphereGeometry(2, 4, 8),
